...
class Traje(models.Model):
    ...
    LINEAS = [
        (LINEA_IMPORTADA, "Línea importada"),
        (LINEA_NACIONAL, "Línea nacional"),
        (LINEA_UNICO, "Talles únicos"),
    ]
...
class TalleColorTraje(models.Model):
    ...
    def __str__(self):
        return f"{self.color} | Saco {self.talle_saco} | Pantalón {self.talle_pantalon}"
